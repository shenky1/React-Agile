...
namespace TrelloAPI.Controllers
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        [HttpGet("getCommentsForCard/{id}")]
        public async Task<ActionResult<CommentResponse>> GetCommmentsForCard(long id)
        {
            var commments = await _commentService.GetCommentsForCard(id);
